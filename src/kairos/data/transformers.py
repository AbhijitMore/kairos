...
class AdultFeatureEngineer(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X):
        ...
        for col in ['capital_net', 'age_bin', 'hours_per_edu', 'hrs_edu', 'age_edu', 'cap_gain_tax']:
        ...
        if 'age' in X.columns and 'education_num' in X.columns:
            ...
            X['cap_gain_tax'] = X['capital_gain'] * (X['age'] / 100.0) if 'capital_gain' in X.columns else 0

...
logger = setup_kairos_logger("kairos.core.models")
...
class HybridEnsemble(ClassifierMixin, BaseEstimator):
    ...
    def fit(self, X: Any, y: Any):
        ...
        cat_features = X_data.select_dtypes(
    ...
    def predict_proba(self, X: Any) -> np.ndarray:
        # Pass data directly to models to preserve Categorical dtypes for LightGBM
        # Do NOT convert to .values() as it converts categories to object/string
        X_vals = X
    ...
    def load(cls, directory: str):
        ...
        )  # Empty params as models are pretrained
